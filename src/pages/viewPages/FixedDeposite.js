...
import { openFixedDepositeDialogReducer, refreshDataTable, callChangeReducer, cpReducer } from 'store/reducers/menu';
...
export default function FullScreenDialog() {
    ...
    var { openFixedDepositeDialog, loader, currentUserId } = menu;
    console.log(menu);
    console.log(openFixedDepositeDialog);
    ...
    useEffect(() => {
        setOpen(openFixedDepositeDialog);
    }, [openFixedDepositeDialog]);
    ...
    const handleClose = () => {
        setOpen(false);
        dispatch(openFixedDepositeDialogReducer({ openFixedDepositeDialog: false }));
        ...
        <div>
            <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition}>
                ...
                <List>
                    <Card>
                        <CardContent>
                            <h1 style={{ marginLeft: 20, marginBottom: 0 }}>FIXED DEPOSIT</h1>
                        </CardContent>
                        <CardContent>
                            <form noValidate autoComplete="off">
                                <div style={{ marginLeft: '5vw', marginBottom: '2vw', display: 'flex' }}>
                                    <div style={{ marginRight: 20 }}>
                                        <Typography style={{ marginBottom: 20 }}>Name of Financial Institution</Typography>
                                        <TextField
                                            id="outlined-basic"
                            ...
                            <Grid item xs={12}>
                                <Paper className={classes.paper}>
                                    ...
                                    <Box sx={{ display: 'flex' }}>
                                        {docId ? (
                                            loader ? (
                                                <Datatable stockData={stockData} finType={'FixedDeposite'} lcDate={'Maturity'} />
                                            ) : (
                                                <CircularProgress
                                                    size="1rem"
                                                    color="inherit"
