...
import { openCryptoDialogReducer, refreshDataTable,callChangeReducer,cpReducer } from 'store/reducers/menu';
...
export default function FullScreenDialog() {
    ...
    var { openCryptoDialog, loader, currentUserId } = menu;
    console.log(menu);
    console.log(openCryptoDialog);
    ...
    const stockDataCollentionRef = collection(db, 'Crypto');
    ...
    const handleClose = () => {
        setOpen(false);
        dispatch(openCryptoDialogReducer({ openCryptoDialog: false }));
        ...
        <div>
            <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition}>
                ...
                <List>
                    <Card>
                        <CardContent>
                            <h1 style={{ marginLeft: 20, marginBottom: 0 }}>CRYPTO CURRENCY </h1>
                        </CardContent>
                        <CardContent>
                            <form noValidate autoComplete="off">
                                <div style={{ marginLeft: '5vw', marginBottom: '2vw', display: 'flex' }}>
                                    <div style={{ marginRight: 20 }}>
                                        <Typography style={{ marginBottom: 20 }}>Name of Crypto Currency</Typography>

                                        <TextField
                                            select
                                            id="outlined-basic"
                                            label="Name of Crypto Currency"
                                            style={{ width: '40vw' }}
                                            value={stockName}
                            ...
                            <Grid item xs={12}>
                                <Paper className={classes.paper}>
                                    ...
                                    <Box sx={{ display: 'flex' }}>
                                        {docId ? (
                                            loader ? (
                                                <Datatable stockData={stockData} finType={'Crypto'} lcDate={'Last Checked'}/>
                                            ) : (
                                                <CircularProgress
                                                    size="1rem"
                                                    color="inherit"
