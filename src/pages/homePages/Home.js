                ...
                <div className="container">
                    <div className="row gy-4 d-flex justify-content-between">
                        ...
                        <div className="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                            {/* <img src={} className="img-fluid mb-3 mb-lg-0" alt="" /> */}
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row gy-4">
                        <div className="col-lg-6 position-relative ">
                            <div className="position-relative" style={{ marginTop: 50 }}>
                                <img src={aboutUs2} className="img-fluid" alt="" style={{ height: '25%', width: '110%' }} />
                            </div>
                        </div>
            ...
            <footer id="footer" className="footer">
                <div className="container">
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                            <h4>Contact Us</h4>
                            <p>
                                KIIT University, KIIT Square, <br />
                                Patia, Bhubaneswar (Pin-751031)
                                <br />
                                Orissa,India <br />
                                <br />
                                <strong>Phone:</strong> +91 898xxxxxxx
                                <br />
                                <strong>Email:</strong> 1906080@kiit.ac.in
                                <br />
                            </p>
                        </div>
                    </div>
                ...
                <div className="container mt-4">
                    ...
                    <div className="credits">
                        <Link href="https://bootstrapmade.com/">KIIT</Link>
                    </div>
                </div>
            </footer>
